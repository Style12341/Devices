    ...
    <x-card class="!p-10 max-w-lg mx-auto mt-24">
        ...
        <form method="POST" action="/users">
            ...
            <div class="relative w-full mb-3" x-data="{ show: true }">
                ...
                <input :type="show ? 'password' : 'text'" type="password"
                    class=" border border-gray-200 rounded p-2 w-full" name="password" value="{{ @old('password') }}" />
                <div class=" absolute inset-y-0 right-0 pr-3 pt-3 flex items-center text-sm leading-5 ">
                ...
                @error('password')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}
                        ...
                        1 Numeric and 1 special character.</p>
                @enderror
            </div>
            ...
            <div class="mb-6">
                ...
                <input type="password" class="border border-gray-200 rounded p-2 w-full" name="password_confirmation"
                    value="{{ @old('pasword_confirmation') }}" />
